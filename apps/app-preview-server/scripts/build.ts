...
await $`mkdir ${rootPath}/apps/app-preview-server/dist/storybook/app-frontend-server`;
...
await $`mkdir ${rootPath}/apps/app-preview-server/dist/storybook/ui-elements`;
