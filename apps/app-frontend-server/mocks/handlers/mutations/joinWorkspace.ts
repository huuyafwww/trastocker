...
import type { IMutationJoinWorkspaceArgs } from '@trastocker/graphql-definition';

export const joinWorkspace: CreateHandler = ({ promiseDatabase }) => {
  return graphql.mutation<
    { joinWorkspace: IMutation['joinWorkspace'] },
    IMutationJoinWorkspaceArgs
  >('joinWorkspace', async () => {
